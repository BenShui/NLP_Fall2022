...
class BiLSTM_CRF(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_dim, num_labels, hidden_dropout_prob=0.2):
        """
        :param vocab_size:
        :param num_labels: 序列标注标签的个数
        :param embedding_dim: BiLSTM输入词向量的维度
        :param hidden_dim: BiLSTM输出词向量的维度
        """
    ...
    def forward(self, input_ids, attention_mask=None, pred_mask=None, input_labels=None):
        ...
        :param attention_mask: (batch_size, max_seq_length)
        :param pred_mask: (batch_size, max_seq_length)
